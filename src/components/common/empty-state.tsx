...
export function EmptyState(props: EmptyStateProps) {
  ...
  const headingContent = headingTx
    ? translate(headingTx, headingTxOptions)
    : heading;
  const contentContent = contentTx
    ? translate(contentTx, contentTxOptions)
    : content;
  const buttonContent = buttonTx
    ? translate(buttonTx, buttonTxOptions)
    : button;
  ...
  const imageClasses = cn('w-32 h-32 mb-6', imageClassName);
  ...
  const buttonClasses = cn(buttonClassName);
